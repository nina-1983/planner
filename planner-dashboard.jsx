...
<head>
  ...
  <title>My Planner Dashboard</title>
...
<body>
  ...
  <script type="text/babel">
    ...
    function PlannerDashboard() {
      ...
      const todayQuote = quotes[today.getDay() % quotes.length];
          ...
          const response = await fetch("https://api.anthropic.com/v1/messages", {
            ...
            body: JSON.stringify({
              ...
              messages: [
                {
                  role: "user",
                  content: `Use Notion tools to fetch Nina's planner data:
1. Query My Tasks: https://www.notion.so/325c1adacbe780dd883ef6b16f3b5855
2. Query Client Work Board: https://www.notion.so/325c1adacbe78069a815f10225fe8910?v=f32171a8-d34a-4009-ae8c-57f1c0cbdbc0
3. Fetch Daily Home Board: https://www.notion.so/dd7ba18f385d407c977d1eb47f0671f2

Return only valid JSON:
{
  "weekTasks": [{"name": "...", "priority": "...", "dueDate": "...", "status": "..."}],
  "clientFocus": [{"client": "...", "focus": "...", "nextStep": "..."}],
  "homeToday": {"mealPlan": "...", "movement": "...", "dailyBasics": [], "homeAnchors": [], "energyNote": "..."}
}`
                },
              ],
              mcp_servers: [
        ...
        <div className="planner">
          <div className="inner">
            ...
            <div className="card">
              ...
              {todaysTasks.length === 0 && weekTasks.length === 0 && clientFocus.length === 0 && (
                <p style={{ color: "var(--muted)", fontSize: "13px" }}>No work data yet. Hit "Sync Notion" to pull your tasks and client focus.</p>
              )}
            </div>

            <div className="card">
              <h2 className="card-title">Home</h2>
              {Object.keys(homeToday).length > 0 && (homeToday.mealPlan || homeToday.movement || homeToday.energyNote || homeToday.dailyBasics || homeToday.homeAnchors) ? (
    ...
    ReactDOM.render(<PlannerDashboard />, document.getElementById('root'));
  </script>
</body>
</html>
